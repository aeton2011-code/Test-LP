  ...
  return (
    <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <FeatureBlock 
                title="المحرك اللغوي (Saudi Native)"
                desc="نماذج ذكاء اصطناعي مدربة خصيصاً على اللهجات السعودية والخليجية لإنتاج محتوى لا يبدو آلياً."
                icon={PenTool}
            ...
            <FeatureBlock 
                ...
                icon={Video}
                items={["تغيير خلفيات المنتجات", "تحريك الصور (Veo Technology)", "توليد صور تخيلية", "تحسين جودة الصور"]}
            />
            <FeatureBlock 
                title="التخطيط الآلي"
