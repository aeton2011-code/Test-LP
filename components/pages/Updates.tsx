        ...
        <div className="relative pr-4 md:pr-0">
            ...
            <UpdateItem 
                ...
                changes={[
                    ...
                    "إطلاق ميزة 'التحليل الذكي' للمتاجر المرتبطة بسلة.",
                    "تحسين دقة اللهجة السعودية في المودل اللغوي."
                ]}
            />
            <UpdateItem 
                version="v1.5.0"
